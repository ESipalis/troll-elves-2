...
--[[
  ...
  -Additionally, ensure that you have the trollnelves2_attachments.xml, trollnelves2_attachments.js, and trollnelves2_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure trollnelves2)", FCVAR_CHEAT )
