...
function UpdateItem()
{
	...
	$.GetContextPanel().SetHasClass( "disabled", Items.IsMuted(m_Item) );
...
function ItemShowTooltip()
{
	...
	var itemName = Abilities.GetAbilityName( m_Item );
	var element = $.GetContextPanel();
	var text = $.Localize("DOTA_Tooltip_ability_" + itemName, element);
	if(Abilities.GetManaCost(m_Item) > 0){
		text = text + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='file://{images}/custom_game/manaCost.png'/>&nbsp;" + Abilities.GetManaCost(m_Item) + "</font>";
	}
	if($.Localize("DOTA_Tooltip_ability_" + itemName + "_Description", element).length > 0){
		text = text + "<br>" + $.Localize("DOTA_Tooltip_ability_" + itemName + "_Description", element)
	}
	if(CustomNetTables.GetTableValue("items", "buy_"+itemName)){
		var item = CustomNetTables.GetTableValue("items", "buy_"+itemName);
		if(item.bonus_stats){
	...
	$.DispatchEvent("DOTAShowTextTooltip", element, text);
}
...
function OnDragEnd( panelId, draggedPanel )
{
	...
	if (!draggedPanel.m_DragCompleted){
		...
		Game.PrepareUnitOrders( dropItemOrder );
